...
We post our release notes to [Exposition](https://blog.expo.io/), for example the [v24.0.0 release notes](https://blog.expo.io/expo-sdk-v24-0-0-is-now-available-bfcac3b50d51). If you're upgrading by more than one major version, we recommend following the upgrade guide for each major version between your current version and your target.
